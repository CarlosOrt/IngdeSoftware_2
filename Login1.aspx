    ...
    <div id="abrigo_general" align="center">
        ...
        <div id="content_Login">
            ...
            <table>
                    ...
                    <tr>
                        <td>
                            <asp:Image ID="imgLogin" runat="server" ImageUrl="~/images/llaves-login.png" Width="56px" Height="56px" />
                        </td>
                        <td align="left">
                            Inicio de sesion
                        </td>
                    ...
                    <tr>
                        <td colspan="2" align="center"><asp:Button ID="btnAceptar" runat="server" OnClick="btnAceptar_Click" Text="Aceptar" Width="78px" /><asp:Button ID="btnRegresar" runat="server" OnClick="btnRegresar_Click" Text="Regresar" /></td>         
                    </tr>

            </table>
    </div>        

          <div id="footer"> &copy; Copyright 2017 by Steven Adrian Vasco | All Right Reserved | Contactos: 0984505329</div>
          </div>
    </form>
</body>
</html>
